...
@section('title', __('admin.credit_packages.create'))
...
<div class="page-header mb-4">
    <div class="row align-items-center">
        <div class="col">
            ...
            <h2 class="page-title">{{ __('admin.credit_packages.create') }}</h2>
        </div>
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control" required autofocus
                               placeholder="{{ __('admin.credit_packages.form.name_placeholder') }}">
                        <div class="invalid-feedback" data-field="name"></div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label required">{{ __('admin.credit_packages.form.credits') }}</label>
                            <input type="number" name="credits" class="form-control" required min="1" value="10">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="price" class="form-control" required min="0" step="0.01" value="0.00">
                        ...
                        <div class="col-md-2 mb-3">
                            ...
                            <input type="text" name="currency" class="form-control" required maxlength="3" value="TRY">
...
$('#create-package-form').on('submit', function (e) {
    ...
    axios.post('{{ route('admin.credit-packages.store') }}', new FormData(this))
        .then(function (res) {
