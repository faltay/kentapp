...
@section('title', __('admin.agents.create'))
...
<div class="page-header mb-4">
    <div class="row align-items-center">
        <div class="col">
            ...
            <h2 class="page-title">{{ __('admin.agents.create') }}</h2>
        </div>
...
<form id="create-agent-form" enctype="multipart/form-data">
    @csrf
    <div class="row">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <select id="working-neighborhoods-select" name="working_neighborhoods[]" multiple
                                    placeholder="{{ __('admin.agents.form.area_placeholder') }}"></select>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <select name="certificate_status" class="form-select">
                        <option value="none">{{ __('admin.agents.certificate.none') }}</option>
                        <option value="pending">{{ __('admin.agents.certificate.pending') }}</option>
                        <option value="approved">{{ __('admin.agents.certificate.approved') }}</option>
                        <option value="rejected">{{ __('admin.agents.certificate.rejected') }}</option>
                    </select>
...
$('#create-agent-form').on('submit', function (e) {
    ...
    axios.post('{{ route('admin.agents.store') }}', new FormData(this))
        .then(function (res) {
