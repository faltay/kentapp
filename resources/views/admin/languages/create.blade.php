...
<div class="page-header mb-4">
    <div class="row align-items-center">
        <div class="col">
            ...
            <h2 class="page-title">{{ __('admin.languages.create') }}</h2>
        </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="code" class="form-control" maxlength="2" placeholder="en" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="native" class="form-control" placeholder="English" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="flag" class="form-control" maxlength="10">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="direction" class="form-select" required>
                                <option value="ltr">{{ __('admin.languages.form.direction_ltr') }}</option>
                                <option value="rtl">{{ __('admin.languages.form.direction_rtl') }}</option>
                            </select>
...
@push('scripts')
<script>
$('#create-language-form').on('submit', function (e) {
    e.preventDefault();
    var btn = $('#submit-btn');
    ...
    axios.post('{{ route('admin.languages.store') }}', new FormData(this))
        .then(function (res) {
