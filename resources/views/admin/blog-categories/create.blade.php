...
@section('title', __('admin.blog_categories.create'))
...
<div class="page-header mb-4">
    <div class="row align-items-center">
        <div class="col">
            ...
            <h2 class="page-title">{{ __('admin.blog_categories.create') }}</h2>
        </div>
...
<form id="create-blog-category-form" data-action="{{ route('admin.blog-categories.store') }}">
    @csrf
    ...
    <div class="row">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    ...
                    <div class="card-actions">
                        @foreach($activeLanguages as $lang)
                            <a href="{{ route('admin.blog-categories.create') }}?lang={{ $lang->code }}"
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name[{{ $editLang }}]" class="form-control" required autofocus>
                    ...
                    <div class="mb-0">
                        ...
                        <textarea name="description[{{ $editLang }}]" class="form-control" rows="3"></textarea>
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <input type="number" name="sort_order" class="form-control" value="{{ $nextSortOrder }}" min="0">
...
@push('scripts')
<script>
const form = document.getElementById('create-blog-category-form');
...
form.addEventListener('submit', function(e) {
    ...
    axios.post(form.dataset.action, new FormData(form))
        .then(res => {
