...
@section('title', __('admin.contractors.create'))
...
<div class="page-header mb-4">
    <div class="row align-items-center">
        <div class="col">
            ...
            <h2 class="page-title">{{ __('admin.contractors.create') }}</h2>
        </div>
...
<form id="create-contractor-form" enctype="multipart/form-data">
    @csrf
    <div class="row">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="authorized_name" class="form-control">
                        ...
                        <div class="col-md-12">
                            ...
                            <select id="working-neighborhoods-select" name="working_neighborhoods[]" multiple
                                    placeholder="{{ __('admin.contractors.form.area_placeholder') }}"></select>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <select name="certificate_status" class="form-select">
                        <option value="none">{{ __('admin.contractors.certificate.none') }}</option>
                        <option value="pending">{{ __('admin.contractors.certificate.pending') }}</option>
                        <option value="approved">{{ __('admin.contractors.certificate.approved') }}</option>
                        <option value="rejected">{{ __('admin.contractors.certificate.rejected') }}</option>
                    </select>
...
$('#create-contractor-form').on('submit', function (e) {
    e.preventDefault();
    var btn = $('#submit-btn');
    ...
    axios.post('{{ route('admin.contractors.store') }}', new FormData(this))
        .then(function (res) {
