...
<div class="page-header mb-4">
    <div class="row align-items-center">
        <div class="col">
            ...
            <h2 class="page-title">{{ __('admin.pages.edit') }}: {{ $page->localized_title }}</h2>
        </div>
...
<form id="page-form" data-action="{{ route('admin.pages.update', $page) }}">
    @csrf
    @method('PUT')
                ...
                <div class="card-header">
                    ...
                    <div class="card-actions">
                        @foreach($activeLanguages as $lang)
                            @php $hasContent = $page->hasTranslation($lang->code); @endphp
                            <a href="{{ route('admin.pages.edit', $page) }}?lang={{ $lang->code }}"
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="title[{{ $editLang }}]" class="form-control"
                               value="{{ $page->title[$editLang] ?? '' }}" required autofocus>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-0">
                        ...
                        <textarea name="meta_description[{{ $editLang }}]" class="form-control" rows="2" maxlength="160">{{ $page->meta_description[$editLang] ?? '' }}</textarea>
